...
|---|---|---|---|
| Feature: Pause / resume threads | — | — | **92 B** |
| Feature: Pause / resume actor update scripts | — | — | **190 B** |
| Feature: Check thread state | — | — | **150 B** |
| Feature: Read thread count | — | — | **119 B** |

Turning off every on-by-default switch above frees **551 B** of banked ROM — the full
